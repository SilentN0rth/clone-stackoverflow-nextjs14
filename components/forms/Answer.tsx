    ...
    return (
        <>
            <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center sm:gap-2">
                <h4 className="paragraph-semibold text-dark400_light800 mt-6">Write your answer here</h4>
                <Button
                    className="btn light-border-2 gap-1.5 rounded-md px-4 py-2.5 text-primary-500 shadow-none dark:text-primary-500"
                    onClick={() => {}}>
                    <Image src={"/assets/icons/stars.svg"} alt="" width={12} height={12} className="object-contain" />
            ...
            <Form {...form}>
                ...
                <div className="flex justify-end">
                    <Button type="button" className="primary-gradient mt-10 w-fit text-white" disabled={isSubbmitting}>
