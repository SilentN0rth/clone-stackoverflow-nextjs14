...
import LocalSearch from "../shared/search/LocalSearch";
    ...
    return (
        <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
            <LocalSearch
                ...
                otherClasess="flex-1 max-sm:w-full"
            />

            <Select onValueChange={(value) => handleUpdateParams(value)}>
                <SelectTrigger className="body-regular  background-light800_dark300 text-dark500_light700 line-clamp-1 flex min-h-[56px] items-center gap-3 border-none p-4 sm:max-w-[210px]">
